...
exports.validateReconnection = validateReconnection;
 ...
 */
function validateReconnection(sessionToken, storedSessionToken, disconnectedAt, now) {
    if (sessionToken !== storedSessionToken) {
        return { canReconnect: false, reason: 'token_mismatch' };
    }
    if (now - disconnectedAt >= constants_1.RECONNECT_WINDOW_MS) {
